...
// highlight.js
mix.js('resources/js/highlight.js', 'public/assets/plugins/highlight/highlight.min.js');

// flag-icon-css
mix.copy('node_modules/flag-icon-css/', 'public/assets/plugins/flag-icon-css/');

// sweetalert
mix.js('resources/js/sweetalert.js', 'public/assets/plugins/sweetalert/sweetalert.min.js');
...
// switchery
mix.js('resources/js/switchery.js', 'public/assets/plugins/switchery/switchery.min.js');
