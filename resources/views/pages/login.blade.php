	...
	<div class="login login-with-news-feed">
		...
		<div class="right-content">
			...
			<div class="login-header">
				<div class="brand">
					<img src="/assets/img/logo/favicon.png" class="height-40"></span> {{ config("app.name") }}
			...
			<div class="login-content">
				...
				© 2019 | <a href="http://www.pdamgirimenang.com" target="_blank" class="text-success">PDAM Giri Menang</a>
			</div>
			<!-- end login-content -->
		</div>
		<!-- end right-container -->
